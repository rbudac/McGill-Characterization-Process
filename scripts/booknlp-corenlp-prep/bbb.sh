...
# ಠ_ಠ @ version numbers being a part of the corenlp filenames....

java -cp "$CORENLP_DIRPATH/*" -Xmx8g edu.stanford.nlp.pipeline.StanfordCoreNLP\
 -annotators tokenize,ssplit,pos,lemma,ner,parse -filelist $FILELIST_PATH\
 -outputDirectory $OUTPUT_DIRPATH -outputFormat xml -replaceExtension &> $LOG_PATH
